...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site footer content (one instance)';
    displayName: 'Footer';
    pluralName: 'footers';
    singularName: 'footer';
  };
...
export interface ApiNavigationItemNavigationItem
  ...
  info: {
    description: 'Header/nav menu structure';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mobileOrder: Schema.Attribute.Integer;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Top-level pages (home, about, pricing, etc.)';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable content blocks within pages';
    displayName: 'Section';
    pluralName: 'sections';
  ...
  attributes: {
    anchor: Schema.Attribute.UID;
    ariaLabel: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    backgroundStyle: Schema.Attribute.Enumeration<
      ['light', 'dark', 'brand', 'gradient']
    > &
    ...
    emptyState: Schema.Attribute.Component<'shared.empty-state', false>;
    ...
    hideMobile: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::section.section'
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration (one instance)';
